...
**Note**: The *Fletcher2013b* package was deprecated starting with Bioconductor 3.23 due to package size restrictions. To reproduce this vignette, please install the archived version from Bioconductor 3.21.
